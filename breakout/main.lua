...
function love.load()
    ...
    gSounds = {
        ...
        ['key-pickup'] = love.audio.newSource('sounds/key_pickup.wav', 'static'),
        ['ball-powerup'] = love.audio.newSource('sounds/ball_powerup.wav', 'static'),
...
-- render the keys player has obtained if any
